...
import com.its.mobile.finball.presentation.view.settings.SettingView
...
class SettingFragment : BaseFragment(), SettingView {
    ...
    override fun shareBackupData(path: String) {
        ...
        val uri = FileProvider.getUriForFile(context,
            SHARED_PROVIDER_AUTHORITY, sharedFile)
    ...
    override fun navigateToSubscriptionsShop() = (router as MainRouter).navigateToSubscriptionsShop()
}